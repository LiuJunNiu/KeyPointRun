...
Java_com_niu_keypoint_utils_ModelManager_GetTimeUseSync(JNIEnv *env, jclass type)
{
...
Java_com_niu_keypoint_utils_ModelManager_loadModelSync(JNIEnv *env, jclass type,jobject modelInfo){
...
extern "C"
JNIEXPORT jobject JNICALL
Java_com_niu_keypoint_utils_ModelManager_runModelSync(JNIEnv *env, jclass type, jobject modelInfo, jobject bufList)
{
    // check params
    if(env == nullptr)
    {
