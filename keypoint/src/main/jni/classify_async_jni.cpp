...
Java_com_niu_keypoint_utils_ModelManager_loadModelAsync(JNIEnv *env, jclass type,jobject modelInfo){
...
Java_com_niu_keypoint_utils_ModelManager_runModelAsync(JNIEnv *env, jclass type, jobject modelInfo, jobject bufList, jobject callbacks)
{
    // check params
    if(env == nullptr)
    {
